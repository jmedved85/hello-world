...
namespace BazaSeminari.Controllers
{
    public class SeminarsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdSeminar,Naziv,Opis,Datum,Popunjen")] Seminar seminar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdSeminar,Naziv,Opis,Datum,Popunjen")] Seminar seminar)
        {
